...
const Footer = () => {
    return (
        <div>
            <div  className="w-[300px] font-serif h-40 bg-slate-800 text-center mt-[80px] pt-5 sm:w-[500px] md:w-[700px] md:h-44 lg:w-[1000px] xl:w-[1280px] lg:h-[190px] xl:h-[240px] xxl:w-[1510px] overflow-x-hidden">

                <h1 className="text-[20px] font-sans font-bold text-amber-400 lg:text-[26px] xl:text-[32px] xxl:text-[38px]">JSaha</h1>

                <div className="footer flex text-xs text-white  gap-5 pt-4 px-[55px] mb-4 sm:px-[140px] sm:gap-8 md:px-[220px] md:text-sm md:gap-10 lg:text-base lg:px-[320px] lg:gap-16 xl:text-xl xl:px-[430px] xl:gap-16 xxl:text-2xl xxl:px-[500px] xxl:gap-20 ">
