...
const Choice_Me = () => {
    return (   
        ...
        <div className="w-full overflow-hidden h-fit mt-20 mb-20">
            ...
            <div className='bg-white pt-6 font-serif pb-6 lg:grid grid-cols-2 md:px-2 lg:px-4 xl:pt-8 xl:pb-8'>



            <div className='w-56 h-56 border-4 rounded-full bg-amber-400 justify-self-center border-white overflow-hidden md:w-48 md:h-48 md:self-center lg:w-60 lg:h-60 xl:w-64 xl:h-64'>
            ...
            <div className=" px-5  ">
                <h1 className="text-amber-400 text-xl font-bold sm:text-2xl xl:text-3xl xxl:text-4xl " data-aos="fade-up"
             ...
             <div className="">
                ...
                <div>
                    <ul className=" marker:text-amber-400 list-disc relative left-3 px-3 space-y-4 sm:left-7 reason-list pt-4 xxl:pt-6">
                        <li data-aos="fade-up"
