...
//             <div className='bg-white font-serif pb-6'>
...
//             <div className=" px-5  ">
//                 <h1 className="text-amber-400 text-xl font-bold md:text-3xl lg:text-4xl xl:text-5xl xxl:text-6xl" data-aos="fade-up"
//                   data-aos-duration="600"  data-aos-delay="300" >Why choose me?</h1>
...
//                 <div>
//                     <ul className=" marker:text-amber-400 list-disc relative left-3 px-3 space-y-4 reason-list pt-4">
//                         <li data-aos="fade-up"
//                   data-aos-duration="600"  data-aos-delay="400" >Resposive & Mobile Fast Design</li>
//                         <li data-aos="fade-up"
//                   data-aos-duration="600"  data-aos-delay="500" >Always update myself with new technology</li>
