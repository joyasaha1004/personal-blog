...
<div className="max-w-screen-xl mx-auto px-4">
             ...
             <div className=' bg-white pt-6 font-serif sm:rounded-lg sm:shadow-lg mx-2 pb-6 md:mx-4 lg:grid grid-cols-2 md:px-2 lg:px-4 lg:pt-10 lg:pb-10 xl:mx-6 xl:pt-12 xl:pb-12 '>



            <div className='w-56 h-56 border-4 rounded-full shadow-lg bg-amber-400 justify-self-center border-white overflow-hidden md:w-48 md:h-48 md:self-center lg:w-60 lg:h-60 xl:w-64 xl:h-64'>
            ...
            <div className=" px-5  ">
                <h1 className="text-amber-400 text-xl font-bold sm:text-2xl lg:text-3xl xl:text-4xl " data-aos="fade-up"
