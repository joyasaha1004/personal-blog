...
const Choice_Me = () => {
    return (
        ...
        <div className="w-[300px] relative overflow-x-hidden h-screen bg-white font-serif mt-[100px]  z-30 sm:w-[500px] sm:h-[570px]  md:flex  sm:mt-[100px] md:w-[700px] md:h-[400px] lg:mt-[180px] lg:w-[1000px] lg:h-[500px] xl:w-[1280px] xl:h-[700px] xxl:w-[1500px]  xxl:h-[900px] mb-5 xxl:mt-[100px]">
            ...
            <div className=" pt-80 px-5 absolute sm:pt-[330px] ">
             ...
             <div className="mt-96 sm:mt-[390px] md:mt-[400px] lg:mt-[420px] xl:mt-[440px]
             xxl:mt-[470px]">
                ...
                <div>
                    <ul className="marker:text-amber-400 list-disc pl-8 space-y-3 reason-list px-6 -mt-3 ">
                        <li data-aos="fade-up"
